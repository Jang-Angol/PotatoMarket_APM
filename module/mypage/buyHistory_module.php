...
<?php
    if(isset($_POST["apply_accept"])){
        if($_POST["apply_accept"] == 0){
            echo<<<END
        <li><a class="trade_all">전체 구매 신청 내역</a></li>
        <li class="current"><a class="trade_ing">구매 신청 중인 내역</a></li>
        <li><a class="trade_complete">구매 수락 내역</a></li>
END;
        } else if ($_POST["apply_accept"] == 1) {
            echo<<<END
        <li><a class="trade_all">전체 구매 신청 내역</a></li>
        <li><a class="trade_ing">구매 신청 중인 내역</a></li>
        <li class="current"><a class="trade_complete">구매 수락 내역</a></li>
END;
        } else {
            ...
            echo<<<END
        <li class="current"><a class="trade_all">전체 구매 신청 내역</a></li>
        <li><a class="trade_ing">구매 신청 중인 내역</a></li>
        <li><a class="trade_complete">구매 수락 내역</a></li>
END;
    }
