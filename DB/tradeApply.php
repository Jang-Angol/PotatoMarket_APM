<?php
	...
	if(isset($_POST["reservationChk"])){
		if(isset($_POST["reservation_date"])){
			...
			$sql = "INSERT INTO TRADE_TB(item_no,apply_state,apply_price,apply_user_no,reservation_date) VALUES($item_no, $apply_state, $apply_price, $apply_user_no, $reservation_date);";
		}
	} else {
